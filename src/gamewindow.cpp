...
void GameWindow::gameLoop() {
    ...
    if (deltaSeconds <= 0 || deltaSeconds > 0.25) {
        deltaSeconds = 0.016; // 防止长时间挂起导致跳变，假设60FPS
    }
    lastFrameMs = nowMs;
